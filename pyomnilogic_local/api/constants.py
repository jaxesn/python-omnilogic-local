...
OMNI_API_MAX_RETRIES = 3  # Maximum retries for the entire API flow (e.g. fragmentation errors)
...
MAX_FRAGMENT_WAIT_TIME = 60.0  # Maximum time to wait for all fragments (seconds)
